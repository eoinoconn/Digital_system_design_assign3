...
## - uncomment the lines corresponding to the FPGA pins that are used in the project
## - rename the ports (in each line, after get_ports) to match the top level port names in the project
